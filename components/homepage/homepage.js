...
const items = [
  { id: 1, title: 'Учитель Математики', department: 'НИШ ФМН', type: 'Full-time', location: 'Алматы' },
  { id: 2, title: 'Проффесор экономики ', department: 'Engineering', type: 'Full-time', location: 'Remote' },
  { id: 3, title: 'Учитель искусства ', department: 'Design', type: 'Full-time', location: 'Remote' },
]
const user = {
  name: "Алкенбай Имран",
  email: "imran402@gmail.com",
  imageUrl:"/images/yeasir.jpg"
};
const navigation = [
  { name: "Главная", href: "#", icon: HomeIcon, current: true },
  { name: "Теги", href: "/tags", icon: ArrowTrendingUpIcon, current: false },
...
export default function HomePage({search}) {
  ...
  const [tabs, setTabs] = useState([
    { name: "Недавнее ", current: true },
    { name: "Больше просмотров", current: false },
    { name: "Больше ответов", current: false },
  ])
