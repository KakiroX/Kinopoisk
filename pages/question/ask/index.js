                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          placeholder="например Новый фильм про программистов уже в прокате."
                  ...
                  <li className="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                    <div>
                      ...
                      <p
                        ...
                        id="tag-description"
                      >
                        Добавьте до 5 тегов. Теги должны быть разделены запятой.
                      </p>
                      <div className="mt-1">
                        <input
                          type="text"
                          ...
                          className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                          placeholder="Впечатление о фильме, Ляпы"
